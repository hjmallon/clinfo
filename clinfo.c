...
const DeviceParameter device_parameters[] = {
	...
	{ CL_DEVICE_COMPUTE_CAPABILITY_MAJOR_NV, "CL_DEVICE_COMPUTE_CAPABILITY_MAJOR_NV", "NVIDIA: CUDA major", printUint, printUint, ADVANCED },
	{ CL_DEVICE_COMPUTE_CAPABILITY_MINOR_NV, "CL_DEVICE_COMPUTE_CAPABILITY_MINOR_NV", "NVIDIA: CUDA minor", printUint, printUint, ADVANCED },
	{ CL_DEVICE_REGISTERS_PER_BLOCK_NV, "CL_DEVICE_REGISTERS_PER_BLOCK_NV", "NVIDIA: Registers per block", printUint, printUint, ADVANCED },
	{ CL_DEVICE_WARP_SIZE_NV, "CL_DEVICE_WARP_SIZE_NV", "NVIDIA: Warp size", printUint, printUint, ADVANCED },
	{ CL_DEVICE_GPU_OVERLAP_NV, "CL_DEVICE_GPU_OVERLAP_NV", "NVIDIA: Concurrent copy", printBool, printBool, ADVANCED },
	{ CL_DEVICE_KERNEL_EXEC_TIMEOUT_NV, "CL_DEVICE_KERNEL_EXEC_TIMEOUT_NV", "NVIDIA: Run time limit", printBool, printBool, ADVANCED },
	...
	{ CL_DEVICE_GLOBAL_FREE_MEMORY_AMD, "CL_DEVICE_GLOBAL_FREE_MEMORY_AMD", "AMD: Free memory", printUint, printUint, ADVANCED },
	{ CL_DEVICE_SIMD_PER_COMPUTE_UNIT_AMD, "CL_DEVICE_SIMD_PER_COMPUTE_UNIT_AMD", "AMD: SIMD/CU", printUint, printUint, ADVANCED },
	{ CL_DEVICE_SIMD_WIDTH_AMD, "CL_DEVICE_SIMD_WIDTH_AMD", "AMD: SIMD width", printUint, printUint, ADVANCED },
	{ CL_DEVICE_SIMD_INSTRUCTION_WIDTH_AMD, "CL_DEVICE_SIMD_INSTRUCTION_WIDTH_AMD", "AMD: SIMD instruction width", printUint, printUint, ADVANCED },
	{ CL_DEVICE_WAVEFRONT_WIDTH_AMD, "CL_DEVICE_WAVEFRONT_WIDTH_AMD", "AMD: Wavefront width", printUint, printUint, ADVANCED },
#endif
...
#define CASE(n) case n: strcat(str, #n); break;

void strcatChanOrder(char* str, cl_channel_order o)
{
	switch(o)
	{
		#ifdef CL_R
		...
		default:
			sprintf(str + strlen(str), "0x%x", o);
	}
}

void strcatChanType(char* str, cl_channel_type o)
{
	switch (o)
	{
		#ifdef CL_SNORM_INT8
...
void printSupportedImageFormats(const char* argv0, cl_device_id device, size_t indent)
{
	...
	{
		char format[256]; format[0] = '\0';
		strcatChanOrder(format, imageFormats[i].image_channel_order);
		strcat(format, " ");
		strcatChanType(format, imageFormats[i].image_channel_data_type);
		if (i == 0)
		{
